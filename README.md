# Software Developer Folio ⚡️ [![GitHub](https://img.shields.io/github/license/saadpasta/developer-portfolio?color=blue)](https://github.com/saadpasta/developerFolio/blob/master/LICENSE) [![GitHub stars](https://img.shields.io/github/stars/salman-06/salmanbarickm-portfolio)](https://github.com/salman-06/salmanbarickm-portfolio/stargazers)  [![All Contributors](https://img.shields.io/badge/all_contributors-4-orange.svg?style=flat-square)](#contributors)
...
If you'd like to **contribute** and make this much better for other users, have a look at [Issues](https://github.com/salman-06/salmanbarickm-portfolio/issues).

Created something awesome for your fork of the portfolio and want to share it? Feel free to open a [pull request](https://github.com/salman-06/salmanbarickm-portfolio/pulls).
...
If the above solution still doesn't work, visit the [wiki page](https://github.com/salman-06/salmanbarickm-portfolio/wiki/Github-Setup-For-Open-Source-Projects).
...
username: "Salman Barick",
  ...
  resumeLink: "https://docs.google.com/document/d/1s64-7-cApJYrrM6HTDHNZR4pWQpORYWJ/edit?usp=drive_link&ouid=101452613115539452204&rtpof=true&sd=true"
};
...
[![Deploy To Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/salman-06/salmanbarickm-portfolio)
...
## For the Future
If you can help us with these. Please don't hesitate to open a [pull request](https://github.com/salman-06/salmanbarickm-portfolio/pulls).
